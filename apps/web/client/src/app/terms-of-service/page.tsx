                ...
                <div className="max-w-4xl mx-auto px-8 py-16">
                    ...
                    <div className="prose prose-invert max-w-none">
                        ...
                        <p className="text-foreground-secondary mb-6">
                            PLEASE READ THESE TERMS OF USE CAREFULLY BEFORE USING THE SERVICES OFFERED BY ON OFF, INC. ("BROWZAI"). BY USING THE SERVICES OR ENTERING ONE OR MORE ORDER FORMS (INCLUDING ANY ONLINE REGISTRATION) (TOGETHER, "REGISTRATION"), YOU ("USER") AGREE TO BE BOUND BY THESE TERMS (TOGETHER WITH THE TERMS OF ANY REGISTRATION, THE "AGREEMENT"). IF YOU ARE ENTERING INTO THIS AGREEMENT ON BEHALF OF AN ENTITY, THEN YOU REPRESENT AND WARRANT THAT YOU ARE AUTHORIZED TO BIND SUCH ENTITY TO THE TERMS OF THIS AGREEMENT.
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">1. Access to the Service</h2>
                        <p className="text-foreground-secondary mb-6">
                            Access to the Service. Subject to User's compliance with this Agreement (including the Registration) Browzai grants User a nonexclusive, non-sublicensable, non-transferable right and license to access and use the Browzai product(s) and/or service(s) (the "Services") solely for User's internal business purposes. User (i) agrees to use the Services in compliance with all applicable local, state, national and foreign laws, treaties and regulations in connection with User's use of the Service (including those related to data privacy, international communications, export laws and the transmission of technical or personal data laws), and (ii) agrees not to use the Service in a manner that violates any third party intellectual property, contractual or other proprietary rights. User agrees to maintain the confidentiality of its access credentials and other account information, and to be responsible for any and all activities under its account. Unless separately agreed in writing, Onlook is under no obligation to provide support for the Service.
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">2. Fees; Payment</h2>
                        <p className="text-foreground-secondary mb-6">
                            User agrees to pay Browzai the fees as set forth in the Registration, if any ("Fees"). Unless otherwise specified in the Registration, all Fees will be invoiced annually in advance and all invoices issued under this Agreement are payable in U.S. dollars within thirty (30) days from date of invoice. Past due invoices are subject to interest on any outstanding balance of the lesser of 1.5% per month or the maximum amount permitted by law. User will be responsible for all taxes associated with its use of the Services (excluding taxes based on Onlook's net income).
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">3. Ownership; Feedback</h2>
                        <p className="text-foreground-secondary mb-6">
                            Browzai owns and retains all right, title, and interest in and to the Services, and all configuration tools, modules, software, products, works, and other intellectual property and moral rights related thereto or created, used, or provided by Onlook for the purposes of this Agreement, including any content or trademarks text, graphics, user and visual interfaces, photographs, logos, sounds, music, artwork, applications, computer code and associated documentation, the design, structure, arrangement, and "look and feel" of such content, and any improvements, updates, enhancements, copies and derivative works of the foregoing. Any software, tools and other materials distributed or otherwise provided to User (including without limitation any software identified in the Registration) will be deemed a part of the "Services" and subject to all of the terms and conditions of this Agreement. No rights or licenses are granted to User except as expressly and unambiguously set forth in this Agreement. User may (but is not obligated to) provide suggestions, comments or other feedback to Onlook with respect to the Service ("Feedback"). User agrees that Onlook will be free to use the Feedback for any purpose without any further accounting to User.
                        </p>
                        ...
                        <p className="text-foreground-secondary mb-6">
                            You agree that Browzai may send you emails concerning our products and services, as well as those of third parties. You may opt out of promotional emails by responding to the promotional email itself or emailing us at contact@browzai.com.
                        </p>
